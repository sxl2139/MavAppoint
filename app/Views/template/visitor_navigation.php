...
<!--        <li><a href="?c=--><?php //echo $advisingController?><!--&a=--><?php //echo $getAdvisingInfoAction?><!--"><font style="color: #e67e22" size="3">Advising</font></a></li>-->
        <li><a href="?c=<?php echo $registerController?>"><span class="glyphicon glyphicon-user"><font style="margin-left:5px; color: #e67e22" size="3">Register</font></a></li>
        <li><a href="?c=<?php echo $loginController?>"><span class="glyphicon glyphicon-log-in"><font id="login" style="margin-left:5px; color: #e67e22" size="3">Login</font></a></li>
    </ul>
</div>
</div>
</nav>